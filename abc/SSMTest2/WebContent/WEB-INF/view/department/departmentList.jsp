...
<body>
	<div class="box">
		...
		<div class="actions">
			<div>
				<a class="btn btn-primary" href="<c:url value="/addDepartment"/>">添加部门</a>
			</div>
		</div>
		<table class="list">
            <tr>
            ...
            <tr>
               ...
               <fmt:formatDate value="${department.d_updatetime }" type="both" pattern="MM-dd HH:mm"/>
                 ...
                 <td>
                	<a class="fa fa-pencil" title="编辑" href="<c:url value="/updateDepartment?id=${department.d_id}"/>"></a>
                	&nbsp;&nbsp;
                	<a class="fa fa-remove" title="删除" href="<c:url value="/deleteDepartment?id=${department.d_id}"/>"></a>
                </td>
            </tr>
            </c:forEach>
        </table>
