...
<body>
	<div class="box">
		...
		<form action="<c:url value="/updateNotice" />" method="post">
				...
				<tr>
					...
					<td class="control" >
						<select name="n_departmentid">
							...
							<option value="${department.d_id }" ${notice.n_departmentid ==department.d_id?"selected":"" }>${department.d_name }</option>
							</c:forEach>
						</select>
					</td>
				</tr>
			...
			<div class="buttons">
				<input type="hidden" name="n_userid" value="${ notice.n_userid }">
